...
export default function StatusNIM() {
  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-start justify-start p-4">
      ...
      {/* DATA MAHASISWA */}
      <div className="mt-10 flex w-full flex-col items-center justify-start gap-4">
                ...
                <table className="w-full text-left ">
                  <tbody>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="px-4 py-2">
                        {formatDate(
                          new Date(data.status_pendaftaran.jadwal_interview),
                        )}
                      </td>
                    </tr>
                    <tr>
              ...
              <>
                ...
                <div className="flex flex-row gap-8">
                  <div>
                    ...
                    <p>
                      {formatDate(new Date(data.status_seminar.jadwal_seminar))}
                    </p>
                  </div>
                  <div>
              ...
              <>
                ...
                <div className="flex flex-row gap-8">
                  <div>
                    <p className="mb-2 font-bold">Jadwal</p>
                    <p>
                      {formatDate(new Date(data.status_sidang.jadwal_seminar))}
                    </p>
                  </div>
                  <div>
                    <p className="mb-2 font-bold">Ruangan</p>
