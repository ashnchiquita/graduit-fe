  ...
  return (
    ...
    <div className="w-full rounded-2xl bg-white p-6 text-base md:px-10 md:py-8 my-4">
        ...
        <div className="flex flex-col space-y-1 overflow-hidden">
                ...
                <div className="text-base text-muted-foreground">Jenis Sidang</div>
                </div>
                <ScrollArea className="flex-1">
                <div className="pl-9 text-sm md:text-base">
                    {'data.data.deskripsi'}
            ...
            <div className="flex flex-col space-y-1 overflow-hidden">
                ...
                <div className="text-base text-muted-foreground">Judul Sidang / Seminar </div>
                </div>
                <ScrollArea className="flex-1">
                <div className="pl-9 text-sm md:text-base">
                    {'data.data.deskripsi'}
          ...
          <div className="flex flex-col space-y-1 overflow-hidden">
            <div className="flex w-full items-center gap-3">
              ...
              <div className="text-base text-muted-foreground">Berkas Terkait</div>
            </div>
            <ScrollArea className="flex-1">
