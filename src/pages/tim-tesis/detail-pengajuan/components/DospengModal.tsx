...
import useDosbingModal from "../hooks/useDosbingModal";
...
import { VscChromeClose } from "react-icons/vsc";
  ...
  export default function DospengModal({
    ...
    const { dialogOpen, setDialogOpen, form } =
      useDosbingModal(dosenPenguji);
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        ...
        <DialogContent className="max-w-[330px] rounded-md md:max-w-[425px]">
          <DialogHeader className="gap-2">
            <DialogTitle className="text-left">Tambah/Ubah Dosen Penguji</DialogTitle>
                              ...
                              >
                                ...
                                <button
                                  onClick={()=>{
                                    form.setValue(
                                      "dosbings",
                                      form.getValues().dosbings.filter((v) => v.id !== val.id),
                                    );
                                  }}
                                >
                                  <VscChromeClose/>
